...
<head>
    ...
    <title>Flower Arranging Class</title>
...
<?php include('navbar.php'); ?>
    <main>
        <div class="carousel">
            <img src="image55.png" alt="Flower 1" class="active" />
            <img src="image66.png" alt="Flower 2" />
            <button class="prev">&#10094;</button>
            <button class="next">&#10095;</button>
        </div>
        <div class="details">
            <h1>Flower Arranging Class</h1>
            <p>Learn how to create a flower bouquets.</p>


            <form action="checkout_Flower_Arranging.php" method="POST">
                <!-- ราคา + จำนวน -->
                ...
                <!-- ซ่อนค่า workshop -->
                <input type="hidden" name="Workshop" value="Flower Arranging Class" required>
                <input type="hidden" name="Price" value="3400" required>
