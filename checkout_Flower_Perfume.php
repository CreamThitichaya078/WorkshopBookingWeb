...
<body>
    ...
    <main>
        <form action="submit_checkout2.php" method="POST">
            <div class="checkout-title">Checkout</div>
            <hr>

            <div class="cart-item">
            <img src="image77.png" alt="Flower Class">
            <div class="cart-info">
                <h2>Flower Perfume Class </h2>
            ...
            <input type="hidden" name="Workshop" value="Flower Perfume Class">
